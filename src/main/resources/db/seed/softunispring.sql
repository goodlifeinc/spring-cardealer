...
-- Дъмп данни за таблица softunispring.cars: ~358 rows (approximately)
...
-- Дъмп данни за таблица softunispring.customers: ~30 rows (approximately)
...
-- Дъмп данни за таблица softunispring.parts: ~131 rows (approximately)
...
-- Дъмп данни за таблица softunispring.parts_cars: ~1 170 rows (approximately)
...
-- Дъмп данни за таблица softunispring.sales: ~50 rows (approximately)
...
-- Дъмп данни за таблица softunispring.suppliers: ~31 rows (approximately)
